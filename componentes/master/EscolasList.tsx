...
const EscolasList: React.FC<Props> = ({
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white p-5 md:p-10 rounded-lg border border-slate-200 shadow-sm relative">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-4">
          {filtradas.map((e) => (
            <div key={e.id} className="p-4 md:p-6 bg-slate-50 border border-slate-100 rounded-lg flex flex-col lg:flex-row lg:items-center justify-between group hover:bg-white hover:shadow-2xl transition-all duration-500 gap-4">
              ...
              <div className="flex items-center gap-4 md:gap-6 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  <h4 className="text-base md:text-xl font-black text-slate-900 leading-tight truncate sm:whitespace-normal sm:line-clamp-2">{e.nome}</h4>
